<template>
  <section class="my-8 flex flex-col gap-y-7 gap-x-7 md:flex-row md:flex-wrap">
    <div class="flex flex-col items-center justify-between md:items-start flex-1 gap-y-5">
        <h1 class="text-5xl text-[#000] font-grotesk font-medium md:text-6xl">Navigating the digital landscape for success</h1>
        <img class="md:hidden" src="../assets/imgs/Illustration.png" alt="">
        <p class="font-normal font-grotesk text-[#000] text-base md:text-xl">Our digital marketing agency helps businesses grow and succeed online through a range of services including SEO, PPC, social media marketing, and content creation.</p>
        <button class="w-full md:w-1/2 block py-5 px-9 bg-[#191A23] text-[#fff] text-xl font-grotesk rounded-2xl">Book a consultation</button>
    </div>
    <div class="flex-1">
